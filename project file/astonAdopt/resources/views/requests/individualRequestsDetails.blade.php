...
<div class="flex justify-center">
  <div class="rounded-lg w-3/4 bg-gray-600 p-4">
    <h1 class="text-gray-200 text-center mb-4 text-xl font-bold">Details</h>
      ...
      <form action="{{route('individualRequests.details', [$animal->id] )}}" method="post">
        @csrf
        @method('delete')
        <div class="mb-4">
          <button type="submit" class="px-4 py-3 bg-blue-500 w-1/4 text-black rounded mt-4 mb-4">Cancel Request</button>
        </div>
      </form>
      ...
      <a href="{{route('individualRequests')}}" >Go back</a>
  </div>
</div>
@endsection
